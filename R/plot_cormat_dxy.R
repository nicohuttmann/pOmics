...
#' @importFrom magrittr %>% 
#'
plot_cormat_dxy <- function(data, dend_x, dend_y) {
  ...
  cowplot::plot_grid(NULL, p_dend_x, p_dend_y, p_heatmap, align = 'hv',
                     rel_widths = c(.2, 1), rel_heights = c(.2, 1))
